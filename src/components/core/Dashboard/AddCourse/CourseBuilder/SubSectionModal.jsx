...
const SubSectionModal = ( {modalData,
    ...
    const {
        register, setValue, getValues, formState:{errors}, handleSubmit
    } = useForm();
    ...
    const onSubmit = async(data)=>{
        ...
        if(edit){
            if(!isFormUpdated){
                toast.error("No changes done in the form");
            }
            else{
                // edit karo
        ...
        // console.log("FormDATA  IN SUBSECTION MODAL" ,formData);
        ...
        if(result){
            ...
            const updatedCourseContent = course.courseContent.map((section) =>
              ...
              console.log("I am in Subscription modal updated course",updatedCourseContent);
              dispatch(setCourse(updatedCourse))
    }
